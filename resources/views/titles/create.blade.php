<x-app-layout>
    <H1 class="block text-2xl font-medium text-gray-400" >Voeg een Film of Serie toe</H1>
    <form method="POST" action="{{ route('titles.store') }}" class="space-y-4">
        ...
        <option value="" disabled @selected(old('type')===null)>-- Kies type --</option>
        ...
        <input
            type="text" name="year" id="year" value="{{ old('year') }}"
